...
export const NosotrosComponent = ({title, text}) => {
  return (
    <div>
            ...
            <card className="w-[300px] text-center items-center p-5 m-5 rounded-3xl">
                ...
                <p className='text-black mt-4 font-bold'>{text}</p>
            </card>
...
{/* <card className="bg-SoftOrange  w-[300px] items-center p-5 m-5 rounded-3xl">
                
<h3 className='text-[20px] font-bold text-center'>Área de Capacitación Deportiva</h3>
<p className='text-VeryDarkBlue mt-4'>
El enfoque en esta área es fundamental para el desarrollo integral de los deportistas. 
...
<h3 className='text-[20px] font-bold text-center'>Área de Capacitación Comercial</h3>
<p className='text-VeryDarkBlue mt-4'>
    Esta área se enfoca en el diseño y ejecución de estrategias destinadas a atraer inversiones y 
...
<h3 className='text-[20px] font-bold text-center'>Área de Capacitación Profesional</h3>
<p className='text-VeryDarkBlue mt-4'>
Se dirige a proporcionar a los deportistas un desarrollo integral que abarque no solo su preparación física 
