...
const Navbar = () => {
    return (
     ...
     sm:items-center '>
                ...
                <li>
                    <a href="/sobre-nosotros" className='hover:text-SoftOrange sm:hover:text-[20px]'>Nosotros</a>
                </li>
                <li>
                    <a href="/contacto" className='hover:text-SoftOrange sm:hover:text-[20px]'>Contacto</a>
                </li>
            </ul>
